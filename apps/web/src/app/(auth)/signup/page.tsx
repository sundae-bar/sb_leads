...
export default function SignupPage() {
  ...
  // OAuth signup: hand off to Supabase, which redirects through the GitHub
  // consent screen and back to /api/auth/callback. From there proxy.ts routes
  // to /onboarding (no tenant yet) or /app (existing tenant).
      ...
      <AuthBackdrop>
        <Card className="w-full">
          ...
          <CardContent>
            ...
            {/* Google OAuth temporarily disabled — re-enable by uncommenting
                the button below + setting GOOGLE_CLIENT_ID/SECRET in the
                Supabase dashboard (Auth → Providers → Google). */}
            <div className="grid grid-cols-1 gap-3">
              <Button variant="outline" disabled={isLoading} onClick={() => handleOAuth('github')}>
              ...
              {/*
              <Button variant="outline" disabled={isLoading} onClick={() => handleOAuth('google')}>
